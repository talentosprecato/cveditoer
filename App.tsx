...
import { GithubIcon, SparklesIcon, InfoIcon, CoffeeIcon } from './components/icons.tsx';
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
                ...
                <h1 className="text-2xl font-bold text-stone-900 tracking-tight font-['Poppins']">Veravox AI CV Editor</h1>
            </div>
